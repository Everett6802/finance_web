...
class WeeklyOptionPremiumCollector(object):

	DEFAULT_SOURCE_FILENAME = "xq_weekly_option_premium.xlsx"
	DEFAULT_SHEET_INDEX = 0
	DATA_CELL_CHECK_NUMBER_COLUMN_INDEX = 4
	DATA_CELL_COLUMN_LIST = [4, 7, 8, 10,] # [成交, 總量, 未平倉, 隱含波動率%,]
	DATA_CELL_COLUMN_TYPE_LIST = ["float", "int", "int", "float",] # [成交, 總量, 未平倉, 隱含波動率%,]
